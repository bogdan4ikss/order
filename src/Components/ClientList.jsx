                ...
                <div class="Client">
                    ...
                    <div class="Client_data">
                        <div class="Client_data_line1">
                            <span className="Client_name">ИМЯ</span>
                            <span className="Client_CompanyName">НАЗВАНИЕ КОМПАНИИ</span>
                        </div>
                        <div className="Client_data_line2">
                            <span className="Client_marka">МАРКА</span>
                            <span className="Client_model">МОДЕЛЬ</span>
                        </div>
                        <div class="Client_data_line3">
                            <span className="Client_telephone">TELEPHONE</span>
                            <span className="Client_email">EMAIL</span>
                        </div>
                            ...
                            <div className="first_line1">
                                <div className="clientlist__line1">
                                    ...
                                    <div className="Client_fordate1_message">
                                        <span className='ClientList_status'>/ RD /</span>
                                        <span className='Clientlist_status_message'>-Прошу расценить</span>
                                    </div>
                                </div>
                ...
                <div class="Client">
                    ...
                    <div class="Client_data">
                        ...
                        <div class="Client_data_line4">
                            ...
                            <div className="first_line">
                                <div className="clientlist__line1">
                                    <span className="Client_date1">10.10.2023</span>
                                    <div className="Client_fordate1_message">
                                        <span className='Clientlist_status_message'>Добрый день, интересует цена и срок поставки</span>
                                    </div>
                                </div>
                                <div className="clientlist_line_buttons">
                                    <a href="#/" className='ccchat'><img src={AWord} className='iconsize' alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
